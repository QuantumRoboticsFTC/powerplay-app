...
import eu.qrobotics.powerplay.teamcode.opmode.auto.trajectories.TrajectoriesLeftMidCtd;
...
@Config
@Autonomous(name = "#4 AutoLeftMidContested")
public class AutoLeftMidContested extends LinearOpMode {
...
//        robot.outtake.bulanVar = 0;
    ...
    public void runOpMode() throws InterruptedException {
        ...
        robot.drive.setPoseEstimate(TrajectoriesLeftMidCtd.START_POSE);
        robot.elevator.isScoring = false;
...
//        PhotonCore.enable();
        ...
        List<Trajectory> trajectories = TrajectoriesLeftMidCtd.getTrajectories(readFromCamera);
